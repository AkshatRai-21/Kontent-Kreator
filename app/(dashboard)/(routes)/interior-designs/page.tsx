...
const RestorePhotoPage = () => {
  ...
  const generatePhoto = async function (fileUrl: string) {
    try {
      ...
      const response = await fetch('/api/interior-designs', {
        method: 'POST',
        headers: {
  ...
  return (
   ...
   <Heading
        title="Interior Ai Designs-Generate"
        description="Take a picture of your room and see how your room looks in different themes. Remodel your room today."
        icon={HomeIcon}
      ...
      <div className="flex justify-between items-center w-full flex-col ">
        ...
        {originalPhoto && !restoredImage && (
          ...
          <div className="flex sm:space-x-4 sm:flex-row flex-col">
            <div>
              <h2 className="mb-1 font-medium text-lg">Input Image</h2>
              <Image
                alt="original photo"
                src={originalPhoto}
            ...
            <div className="sm:mt-0 mt-8">
              <h2 className="mb-1 font-medium text-lg">Output Image</h2>
